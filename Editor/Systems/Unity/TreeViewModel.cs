        ...
        public void Refresh()
        {
            ...
            if (Predicate == null)
            {
                foreach (var item in TreeData)
                {
                    ...
                    item.Icon = treeData == null || !treeData.Children.Any()
                        ? (SingleIconSelector == null ? SingleItemIcon : SingleIconSelector(data))
                        : treeData.Expanded ? "MinusIcon_Micro" : "PlusIcon_Micro";
